...
SELECT clinics.id, clinics.user_id, clinics.name, clinics.location, clinics.business_no, users.id, users.given_name, users.family_name, users.email, users.password, users.role_id, roles.description AS user_role
FROM clinics
